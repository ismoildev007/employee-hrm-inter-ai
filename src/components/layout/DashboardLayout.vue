<template>
  <div class="min-h-screen bg-gray-50 flex">
    ...
    <main class="flex-1 overflow-auto lg:ml-0">
      <!-- Top Header -->
      <header class="bg-white border-b border-gray-200 px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between sticky top-0 z-30">
